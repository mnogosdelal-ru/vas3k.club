...
def resized_image(value, arg="full"):
    if not value or "://i.club.mnogosdelal.ru/" not in value:
        return value

    if is_video(value):
        return value

    if value.startswith("https://i.club.mnogosdelal.ru/full/"):
        return value.replace(
            "https://i.club.mnogosdelal.ru/full/", "https://i.club.mnogosdelal.ru/{}/".format(arg)
        )
    else:
        return value
